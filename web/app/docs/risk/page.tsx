  ...
  return (
    <article>
      ...
      <ul className="mt-6 list-disc space-y-2 pl-5 text-sm leading-relaxed text-white/60">
        ...
        <li>The per-period hedge protects single-day crashes well; against slow multi-day drawdowns it adds little — we document this openly rather than hide it.</li>
